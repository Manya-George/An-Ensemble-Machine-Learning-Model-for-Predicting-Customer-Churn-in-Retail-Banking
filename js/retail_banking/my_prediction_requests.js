                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        <div>
                            <div style="font-size:14px; font-weight:600; margin-bottom:6px; color:#374151;">
                                Request #${req.requestID} • ${new Date(req.requestedAt).toLocaleString()}
                            </div>
                                ...
                                req.status === "resolved"
                                    ? `
                                        ...
                                        <div style="color:#6b7280; font-size:12px;">
                                            Resolved by ${escapeHtml(req.resolvedByUsername || "IT Admin")}
                                        </div>
                                    `
                                    : `<div style="color:#6b7280; font-size:12px;">Awaiting IT</div>`
                            }
                        </div>
                    </div>
